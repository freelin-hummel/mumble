import type { AppClientChatMessage, AppClientChannel, AppClientLiveSession, AppClientParticipant } from "../electron/appClientState.js";
...
const createChannelList = (): AppClientChannel[] => [
  { id: "lobby", name: "Lobby", parentId: null },
  { id: "squad", name: "Squad Room", parentId: "lobby" },
  { id: "afk", name: "AFK", parentId: null }
];

const createBaseParticipants = (nickname: string): AppClientParticipant[] => [
